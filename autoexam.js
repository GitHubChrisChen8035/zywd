...
//更新答案集
var questionsDic1 = `
{"cc037ddd-5c90-4400-a059-3cffb531efe7":{"type":1,"question":"向量数据库的查询通常基于什么来衡量向量之间的相似度？","answers":"余弦相似度"},"234ccf8c-6ea3-4a4c-a421-3b106030ce53":{"type":1,"question":"多模态大模型中，多模态主要指的是（）。","answers":"模型能够处理多种类型的数据"},"af27b91b-5124-42f1-942e-3d58ce6a6d68":{"type":1,"question":"以下哪项模型优化技术可以解决重复计算的问题？（）","answers":"KV Cache"},"923997e2-85ad-4705-8dce-b4125c7111b4":{"type":1,"question":"大模型对于翻译类问题的回答，一般用（ ）评价指标评测翻译的准确性？","answers":"Bleu"},"c62461af-88c2-45b5-917f-f455e72af6f6":{"type":1,"question":"大模型的训练过程中通常需要选择合适的学习率，常用的学习率调整方法包括下列哪一种？","answers":"学习率线性预热"},"771dfd6d-d138-4628-8b6a-6811cc7735cc":{"type":1,"question":"九天网络大模型对现有模型替代率最高的是（）。","answers":"语音"},"4de9ee63-dfd5-4b60-9f62-c3f99a5f7d0f":{"type":1,"question":"卷积神经网络中的池化层（pooling）的主要作用是（）。","answers":"实现信息的降维"},"a5d0b9ec-4b5e-4944-b1a4-829ca3540695":{"type":1,"question":"下面不能作为大模型的量化对象的是（）？","answers":"数据"},"940fee29-8738-493e-9dd9-ff9820c299be":{"type":1,"question":"大模型的数据训练可以来源于（）。","answers":"以上都是"},"0e8126d2-fac1-46ae-9339-ee60d3daaaab":{"type":1,"question":"昇腾910B对标的GPU型号为（）。","answers":"A100"},"79e0ec20-4d41-4a5b-81d9-c9a054d43fc7":{"type":1,"question":"内容安全风险体系是（）级标签。","answers":"3"},"f1ddc4ec-8501-4fe8-a82d-bd374d321c47":{"type":1,"question":"由OpenAI所研发的 ChatGPT大模型的“出圈”，预示着“通用智能”时代的到来，下列功能能够由ChatGPT实现的有（  ）。","answers":"以上都是"},"e60d0aa0-c30f-4428-bacd-345147f7c1ba":{"type":1,"question":"下列属于中国移动公开发布的行业大模型的是（  ）。","answers":"以上都是"},"ecb8b533-d8b1-413f-8567-8b2a9d647ab9":{"type":1,"question":"哪种并行策略的计算效率最低（）。","answers":"张量并行"},"bc9fae3e-3f62-44e6-a15f-7b1b5b498643":{"type":1,"question":"在RAG过程中，怎样利用已有的数据库。","answers":"从数据库中检索到与用户问题相关的部分与用户问题一起放到prompt中"},"a7545de9-4ec0-4bb2-a7b1-466abd57fa9c":{"type":1,"question":"关于泛化性的理解，下列说法正确的是（）。","answers":"模型的泛化性指模型能够胜任某一类场景中的任务"},"d9e185af-ac7a-4897-bf3a-b75a25e40aeb":{"type":1,"question":"语言大模型评测面临的挑战很多，如下说法正确的是（ ）。","answers":"通用语言大模型具备训练数据多元化、能力多样性的特点，因此评测很难保障全面性。"},"6ba6e764-3bb2-49a6-b620-3352d5a40484":{"type":1,"question":"下列几种属于模型压缩的方法的是（）。","answers":"以上都是"},"11b9a7d1-4bfc-4a80-81e6-cd2de0062541":{"type":1,"question":"下列对模型推理优化并行技术中描述不正确的是（）。","answers":"张量并行是指将模型的不同层放在不同的卡上"},"df29a03e-13d5-487e-89f1-3cd6bed94dc6":{"type":1,"question":"面对一个智能语言交互任务，我们通常可以采用下列哪种神经网络？（  ）","answers":"递归神经网络"},"4eb5715f-9184-4e65-adc6-da540fefeda7":{"type":3,"question":"机器学习的输入与输出均由张量表示。","answers":"正确"},"74522521-6e99-4074-bc4d-8462c99e7115":{"type":3,"question":"深度学习的主要结构为神经网络，神经网络由多个神经元构成。","answers":"正确"},"e16e9474-409c-4e74-9ac5-2136cb2bea12":{"type":3,"question":"大模型在一些评测中得分越高，表示大模型能力就越强。  ","answers":"错误"},"4df2c228-46cb-4738-a98e-b0d2a23af69b":{"type":3,"question":"华为昇腾910B支持BF16。","answers":"正确"},"13e45315-2fe7-489c-a54a-6a6cbf512dc9":{"type":3,"question":"BF16精度的指数位比FP16精度的指数位更高。 ","answers":"正确"},"621b4e37-4675-4f57-8c7f-a41f20d00f78":{"type":2,"question":"下列属于大模型五大类评测指标的有（）。","answers":["鲁棒性","安全性","公平性"]},"6d4a02fb-c442-4e32-9340-019c36981f60":{"type":2,"question":"关于大模型训练数据，下列说法正确的是（）。","answers":["行业大模型的训练数据需要来自该行业的特定场景","行业大模型的训练数据应注意时效性","大模型训练数据需要保障数据的合法来源"]},"a575259e-6b85-4df2-8d78-13596d2d49ec":{"type":2,"question":"下列能够满足模仿生成新数据的人工智能结构有（）。","answers":["GAN结构","INFOGAN结构"]},"ad5bfc7b-9446-4d8d-845d-bb666655da7d":{"type":2,"question":"下列属于九天大模型体系特色的是（）。","answers":["供给侧增强","持续训练","异构硬件灵活部署"]},"60c05d9b-5f09-40a8-85be-0419286df3a4":{"type":2,"question":"机器学习根据学习方法与学习信息类别可以分为（）。","answers":["监督学习","强化学习","无监督学习"]},"d4f73137-3e45-4865-accc-ee9d96f8cce8":{"type":1,"question":"关于大模型的云端内容安全审核，下面说法正确的是（）。","answers":"目前云端内容安全审核对于用户输入有3种处理建议"},"7e80608f-1d4a-4f63-9309-650ba681cb64":{"type":1,"question":"生成式对抗网络（Generative adversarial nets）核心是对抗式，两个网络互相竞争，一个负责（ ）样本，另一个负责（ ）样本。（   ）","answers":"生成；判别"},"8f8ffdb4-e10e-4f93-8c8d-92b59f6de8d5":{"type":1,"question":"在大模型微调中，验证集的作用是什么？（）","answers":"以上都是"},"21f143c9-2179-48ca-aadf-8ec058a44380":{"type":1,"question":"哪种并行策略的显存效率最高（） 。","answers":"张量并行"},"94705954-eec5-47b9-94f0-b4cf50e90a49":{"type":1,"question":"大模型推理过程中下面哪个参数不能控制随机性？","answers":"max_new_tokens"},"e3f633af-26f6-4611-8f9d-7fa2663bead2":{"type":1,"question":"下列AI能力，不属于视觉能力的有（  ）。","answers":"智能音频降噪"},"e12e6c1d-f8da-41e7-93cf-fc503d6700fc":{"type":1,"question":"正则函数的意义是（）。","answers":"防止过拟合"},"7d1a46f1-3a98-4de1-b267-86d03a1842af":{"type":1,"question":"以下哪个资源池可以部署大模型服务？（）","answers":"国产GPU资源池"},"b68f816c-3b80-48cc-aaef-e0843fc00d8c":{"type":1,"question":"关于强化学习，下列说法错误的是（）。","answers":"强化学习是独立于深度学习的一种新的算法结构"},"97762e02-6bb8-442a-8aec-9824685068bc":{"type":1,"question":"在大模型训练中，哪种方法通常用于避免过拟合？（）","answers":"以上都是"},"585c1538-e62a-4dd9-b96e-e7858b484e5f":{"type":1,"question":"强化学习中，决策函数的输出是（）。","answers":"智能体采取的下一步行动"},"0eda99dc-8eba-402e-bda2-7f2031494a1f":{"type":1,"question":"以下哪种技术是从显存的角度对大模型推理进行优化的？","answers":"paged attention"},"7605fee1-9d8c-4a40-ac26-a7d1cd433357":{"type":3,"question":"LSTM的门结构模仿了人类对于信息的遗忘与记忆过程。","answers":"正确"},"addc6928-ed4e-45b0-ab74-3516855d39c1":{"type":3,"question":"代价函数只能选用平方差公式。","answers":"错误"},"be2aca37-cc27-48be-a518-c4f1982a139d":{"type":2,"question":"GPU迁移昇腾910B的主要步骤包括：数据预处理、（）。","answers":["分布式框架适配","配置迁移","模型训练"]},"276b5880-37a0-4158-a930-44355d20d2e8":{"type":2,"question":"关于模型评测，下列说法正确的是（）。","answers":["模型要从鲁棒性、安全性等方面进行多维度评测","Prompt包括zero-shot与few-shot两种形式","可以通过诱导性的prompt提问来检测模型是否满足安全性"]},"27f7ecc2-b1d3-4f09-b9e1-906df62ad347":{"type":2,"question":"下列属于对大模型的指令攻击类型的有（）。","answers":["反面诱导","目标劫持","Prompt泄露","角色扮演"]},"7485c314-d42b-43cd-b4c7-c82b0d48b0e0":{"type":2,"question":"评测流程包括（）这些主要环节。","answers":["数据准备","模型注册","查看报告","模型评测"]},"cf4a4e37-c1aa-489a-8e54-4690d6db47f1":{"type":1,"question":"关于并行计算，下列说法错误的是（）。","answers":"数据并行更加适合大模型训练"},"ac046486-cbb5-4f1b-b3e1-18b211054535":{"type":1,"question":"有一个机器学习常用的激活函数（Activation function），当输入小于0时取0，当输入大于等于0时输出等于输入，这个函数是（ ）。","answers":"Relu"},"e3c8cfca-9386-4145-9754-ebb1b983fc04":{"type":1,"question":"关于机器学习的分类，下列说法错误的是（ ）。","answers":"回归问题是一种重要的无监督学习问题"},"2d674249-fd03-49c9-b7a0-ba96151b2266":{"type":1,"question":"神经元节点计算什么？（ ）","answers":"神经元节点先计算线性函数（z = Wx + b），再计算激活函数"},"f5039245-0f5b-436f-bfb8-7e9a0b340438":{"type":1,"question":"大模型训练过程中常用的优化算法包括下列哪一种？","answers":"SGD"},"48c91cf7-3d77-480e-88f2-cac3daf606a5":{"type":1,"question":"九天基础语言大模型的参数目前达到（）。","answers":"13.9B"},"86ad297e-906b-4462-9e59-9ec7fac0366d":{"type":1,"question":"部署大模型服务时，以下哪个操作是错误的？（）","answers":"随意配置多个端口号"},"b7eae032-a45a-476d-958b-384d896c983a":{"type":1,"question":"阿尔法围棋（AlphaGo）是第一个击败人类职业围棋选手、第一个战胜围棋世界冠军的人 工智能机器人，其最核心的机器学习算法应为：（  ）。","answers":"强化学习"},"22a2f6bf-8ab2-421e-ac58-f2fdd441d05c":{"type":1,"question":"九天大模型体系中，作为基础设施内容的是（）。","answers":"以上都是"},"a01d4f31-cfc8-447a-90c7-9ff0dd9e4fc6":{"type":1,"question":"ZeRO策略中，Stage 1是将什么进行了切分（）。","answers":"优化器状态"},"bc1e5fd8-7c52-4e4d-a132-4dd2fe3c8f4c":{"type":3,"question":"神经元节点先计算激活函数，再计算线性函数(z = Wx + b)。","answers":"错误"},"32391a23-9b5b-439d-9d47-d91984da7454":{"type":3,"question":"机器学习可以看作寻找一组输入与输出的函数的过程。","answers":"正确"},"b42ced76-d42f-4937-8783-ef662fd9d85d":{"type":2,"question":"下列属于九天众擎基座大模型训练用领域数据的是（）。","answers":["通信","能源","医疗"]},"f7c09fdd-854d-40c4-9957-29a96f7c5fd4":{"type":2,"question":"在大模型微调中，关于预训练模型的描述正确的是（）。","answers":["预训练大模型包含后续模型的初始权重","预训练大模型可以作为微调模型的基础模型","预训练大模型使用的预训练数据泛化性较强"]}}
`
